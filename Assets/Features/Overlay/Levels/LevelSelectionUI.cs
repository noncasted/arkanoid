...
namespace Features
{
    ...
    public class LevelSelectionUI : MonoBehaviour, ILevelSelectionUI, IScopeSetupCompletion, ISceneService
    {
        ...
        [Inject]
        private void Construct(IOverlayBackground background, ILevelsStorage levelsStorage, IPause pause)
        {
            _pause = pause;
        ...
        public async UniTask<LevelSelectionResult> Process(IUIStateHandle handle)
        {
            _pause.Pause();
